...
export const BlogContent = () => {
    ...
    return <div className=" mt-25 pt-10 w-[80%]  overflow-y-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] mask-y-from-90%">
        <div className='flex justify-between items-end'>
            ...
            <div  onClick={()=>navigate("/profile/publish")} className='text-3xl font-bold flex items-center relative cursor-pointer group'>Write? <img className='w-7 h-7' src={write} />
