    ...
    return <div className="w-[80%] flex justify-between items-center fixed z-10">
        ...
        <div className='flex list-none gap-5 text-lg text-neutral-700 font-semibold'>
            ...
            <li className='group relative cursor-pointer'>
                <div className='hover:border-b hover:text-neutral-500' onClick={() => { navigate("/blogs") }} >Profile</div>
                <motion.div
                    ...
                    <div className='hover:border-b  hover:text-neutral-500' onClick={() => { navigate("/sign-in") }}>Sign out</div>
                </motion.div>
            </li>
        </div>
    </div>
